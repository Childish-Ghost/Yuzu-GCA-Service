...
export function registerTools(server: McpServer): void {
  ...
  server.registerTool(
    'sysinfo',
    {
      ...
      description:
        'Get system information for this device: OS, CPU, memory, disk usage, ' +
  ...
  // All tools available — device operations are gated by gca-server
  // approval (approve_op) and local confirm, not by registration state.
  // Registration state is managed by gca-server/frontend.
  ...
  server.registerTool(
    'exec',
    {
      ...
      description:
        'Execute a shell command on this device. ' +
  ...
  server.registerTool(
    'confirm',
    {
      ...
      description:
        'Execute the operation the user just confirmed in chat. ' +
        'Call with NO arguments to execute the most recent pending ' +
        'operation (exec, file_write/move/delete/serve/fetch, wol). ' +
        'For device registration, power and service approvals, use the ' +
        'gca-server approve_op tool instead — not this confirm tool.',
  ...
  server.registerTool(
    'file_list',
    {
      title: 'List Files',
      description:
        'List the contents of a directory on this device. ' +
  ...
  server.registerTool(
    'file_read',
    {
      title: 'Read File',
      description:
        'Read the content of a text file on this device. ' +
  ...
  server.registerTool(
    'file_write',
    {
      title: 'Write File',
      description:
        'Write or append text content to a file on this device. ' +
  ...
  server.registerTool(
    'file_move',
    {
      title: 'Move File',
      description:
        'Move or rename a file or directory on this device. ' +
        'This is a write operation: it does NOT execute immediately. ' +
        'It returns a confirmToken — ask the user to confirm, then call ' +
  ...
  server.registerTool(
    'file_delete',
    {
      title: 'Delete File',
      description:
        'Delete a file or directory on this device. ' +
        'This is a write operation: it does NOT execute immediately. ' +
        'It returns a confirmToken — ask the user to confirm, then call ' +
  ...
  server.registerTool(
    'file_serve',
    {
      ...
      description:
        'Publish a file on this device for a single one-shot download by ' +
  ...
  server.registerTool(
    'file_fetch',
    {
      ...
      description:
        'Download a file directly from another device using the one-shot ' +
  ...
  server.registerTool(
    'exec_background',
    {
      ...
      description:
        'Start a long-running shell command in the background; returns a taskId ' +
  ...
  server.registerTool(
    'process_list',
    {
      ...
      description:
        'List running processes on this device with CPU time and memory usage. ' +
  ...
  server.registerTool(
    'power',
    {
      title: 'Power Control',
      description:
        'Shutdown, restart, sleep, or hibernate this device, or send a Wake-on-LAN packet. ' +
  ...
  server.registerTool(
    'service',
    {
      ...
      description:
        'List system services (read-only, auto-approved) or start/stop/restart a service. ' +
  ...
  server.registerTool(
    'notify_send',
    {
      ...
      description:
        'Pop a desktop notification on this device to reach the human at the keyboard ' +
  ...
  server.registerTool(
    'screenshot',
    {
      title: 'Screenshot',
      description:
        'Capture everything currently visible on this device\'s screen as a JPEG ' +
  ...
  server.registerTool(
    'screen_consent',
    {
      ...
      description:
        'Grant a time-boxed window (in minutes, max 120) during which the ' +
  ...
  server.registerTool(
    'remote_input',
    {
      title: 'Remote Input',
      description:
        'Send keyboard + mouse events to this device\'s desktop. ' +
  ...
  server.registerTool(
    'input_consent',
    {
      ...
      description:
        'Grant a time-boxed window (in minutes, max 120) during which ' +
  ...
  server.registerTool(
    'clipboard_sync',
    {
      ...
      description:
        'Read or write the system clipboard on this device. ' +
