...
import type { FileEntry, FileListErrorResult, FileListOkResult } from '../../types/tools.js';
...
export async function fileListHandler(args: FileListInput) {
  ...
  try {
    ...
    const body: FileListErrorResult = {
      status: 'error',
      path: rootAbs,
