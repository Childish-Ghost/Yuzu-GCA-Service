 ...
 */
export declare const TOOL_NAMES: readonly ["exec", "confirm", "file_list", "file_read", "file_write", "file_move", "file_delete", "exec_background", "process_list", "power", "service", "notify_send", "sysinfo", "file_serve", "file_fetch", "screenshot", "screen_consent", "remote_input", "input_consent", "clipboard_sync"];
