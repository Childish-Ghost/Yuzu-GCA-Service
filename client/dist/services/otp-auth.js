...
export async function isTotpProvisioned() {
 ...
 */
export async function provisionTotp(account) {
 ...
 */
export async function importTotpSecret(account, secretBase32) {
...
export async function verifyOwnerCode(code) {
    ...
    const lastStep = (await getSetting(LAST_STEP_SETTING)) ?? -1;
