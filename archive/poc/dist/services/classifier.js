...
const DANGEROUS_PATTERNS = [
    ...
    { pattern: /rm\s+(-[a-z]*(?:r[a-z]*f|f[a-z]*r)[a-z]*|--recursive\s+--force|--force\s+--recursive).*\s+\*/i, reason: 'Recursive force delete with wildcard' },
    // Disk formatting
...
export function classifyCommand(command) {
    ...
    const hasRedirect = />\s*\S/.test(trimmed);
